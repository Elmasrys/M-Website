                ...
                <div className="relative">
                  ...
                  <div className="relative bg-white rounded-lg overflow-hidden border border-green-100 p-6 shadow-lg">
                    <div className="flex items-center mb-6">
                      ...
                      <Sparkles className="h-5 w-5 text-green-500 ml-auto animate-pulse" />
                    </div>
                    ...
                    <form className="space-y-4">
                      <div>
                        ...
                        <input 
                          type="text" 
                          id="name" 
                          className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-900"
