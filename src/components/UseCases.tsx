...
const useCases = [
  ...
  {
    icon: <HeadphonesIcon className="h-6 w-6 text-indigo-600" />,
  ...
  return (
    <section id="use-cases" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 p-8 rounded-lg border border-indigo-100 bg-gradient-to-r from-indigo-50 to-purple-50 shadow-md">
          <div className="text-center">
            ...
            <a 
              href="#contact" 
              className="mt-6 inline-flex items-center px-6 py-2 bg-white text-indigo-600 rounded-md border border-indigo-200 hover:border-indigo-300 transition-colors shadow-sm"
            >
              Contact Us
            </a>
          </div>
