      ...
      {isOpen && (
        <div className="md:hidden bg-white/95 backdrop-blur-md shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="#how-it-works" className="block px-3 py-2 text-gray-700 hover:text-indigo-600 transition-colors">How It Works</a>
            <a href="#use-cases" className="block px-3 py-2 text-gray-700 hover:text-indigo-600 transition-colors">Use Cases</a>
            <a href="#testimonials" className="block px-3 py-2 text-gray-700 hover:text-indigo-600 transition-colors">Testimonials</a>
            <a href="#contact" className="block px-3 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-md">
              Get Started
            </a>
          </div>
        </div>
